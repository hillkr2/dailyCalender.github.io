    ...
    $.fn.weekly_schedule = function(callerSettings) {
            ...
            $('.hour').on('click', function() {
                if (selectionMode || removalMode) {
                    if ($(this).parent()[0] == startDay[0]) {
                        ...
                        for (var i = 0; i < children.length; i++) {//selection//
        ...
        function initClickHoverAndClick() {
            $('.hour').on('click', function() { 
                ...
                $(this).removeClass('hover'); //lets you hover over boxs//
            }).on('mouseenter', function() {
                if (!mousedown) {
                    $(this).addClass('hover');
                }
        ...
        function initClickAndDrag() { ///lets you drag down//
